...
namespace SampleClassification.ConsoleApp
{
    public partial class SampleClassification
    {
        ...
        public class ModelInput
        {
            ...
            [LoadColumn(5)]
            [ColumnName(@"DidItFail")]
            public float DidItFail { get; set; }
...
// --- NEW ---
        private static string MLNetModelPath = Path.Combine(AppContext.BaseDirectory, "SampleClassification.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("DidItFail");
            if (labelColumn == null)
            {
                throw new Exception("DidItFail column not found. Make sure the name searched for matches the name in the schema.");
            }
